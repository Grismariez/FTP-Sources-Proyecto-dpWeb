...
$sql="select * from registrados order by id_reg";
...
$pdf->cell(20,60,'Id');
$pdf->cell(30,60,'Nombre');
$pdf->cell(30,60,'Nickname');
$pdf->cell(55,60,'Correo');
$pdf->cell(30,60,'Pais');
$pdf->cell(40,60,'Dui');
$pdf->ln(5);
...
$pdf->cell(20,60,$fila['id_reg']);
$pdf->cell(30,60,$fila['nombres_reg']);
$pdf->cell(30,60,$fila['nickname_reg']);
$pdf->cell(58,60,$fila['email_reg']);
$pdf->cell(20,60,$fila['pais_reg']);
$pdf->cell(40,60,$fila['dui_reg']);
$pdf->ln(5);
}
