...
<html Lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Play Music - Pagar Compra</title>
		...
		<script type="text/javascript" src="Validaciones/validaPagarCompra.js" ></script>
		
		<link rel="stylesheet" href="Css File/Carrito/Compras.css" type="text/css" charset="utf-8"/>
	</head>
	<body class="fondo">
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<center><table width="100%"  cellpadding="0" cellspacing="0" align="center">
							<tr>
							<td width="74%">
							<center><div class="formCompras">
							<form name="frmAutorizar" action="guardarcompra.php" method="post" onsubmit="return validar();">
							<br /><br />
								<table width="242" height="100" align="center">
										<tr>
											<td align="center">
													<font color="#0255A4" size="3"><b> Valor a Pagar </font> 
													<font color="#0255A4" size="4">$ <?php echo number_format($total,2); ?></b></font>
													
											</td>
										</tr>
										<tr>
											<td align="center">
												Usuario: <?php echo $_SESSION['mynombre']; ?>
											</td>
										</tr>
										<tr>
											<td align="center">
												ID:  <?php echo $_SESSION['id_reg']; ?>  
											</td>
											
										</tr>
										<tr>
											<td align="center">
												<a href="vercarrito.php" style="text-decoration:none; color:blue;">Continuar Comprando</a>
											</td>
										</tr>
								</table>
								<br/>
								<table style="width: 90%" align="center" >
										<tr>
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" width="26%" align="right">
											<span ><b>Nombre según tarjeta: </b></span>
										   </td>
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" width="50%">
											 <input type="text" required name="nombre" id="nombre size="40" maxlength="50">
										   </td>
										</tr>
										 <tr>
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" width="26%" align="right">
										   ...
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" width="73%">
											 <input type="text" required name="emisor" id="emisor" size="40" maxlength="35"></td>
										 </tr>
										 <tr>
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" width="26%" align="right">
										   ...
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
											 <input type="text" required name="numero" id="numero" size="20" maxlength="16" onChange="validarSiNumero(this.value);"></td>
										 </tr>
										 <tr>
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" width="26%" align="right">
											<span ><b>Tipo : </b></span>
										   ...
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" width="73%">
												<select size="1" name="tipo" required>
										 ...
										 <tr>
										   ...
										   <td bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF" width="73%">
												<select size="1" name="mesv" required>
													<option>01</option>
													<option>02</option>
													<option>03</option>
													<option>04</option>
												...
												<select size="1" name="aniov" required>
										   ...
										   <td colspan=2 bordercolorlight="#FFFFFF" bordercolordark="#FFFFFF">
											<p class="basic-paragraph basic-paragraph-override-2">
											  <span class="no-style-override-12">Valores reflejados no incluyen IVA.</span></p>
												<input type="hidden" name="idcliente" value="<?php echo $_SESSION['myid']; ?>">
										   </td>
										 </tr>
								</table>
								<table align="center">
