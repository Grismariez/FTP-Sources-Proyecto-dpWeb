...
<html Lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Play Music - Cotizaciones</title>
		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				...
				<!--INICIO DEL FORMULARIO DE COTAZACIÓN-->
					<form name="frmCot" id="frmCot" action="filesphp/insert_cotizacion_publicos.php" method="post" onsubmit="ValidaCampos();">
						<table align="center" style="border-radius:15px;" width="800px" height="779px">
							<tr>
								<td colspan="4">
									<label><font size="3" color="red" face="Palatino linotype"><br /><br /><b>* <?php echo $_SESSION['alertaCott']; session_destroy(); ?></b><br /></font></label>
								</td>
							</tr>
							<tr>
								<td colspan="4">
							...
							<tr>
								<td align="center" colspan="4">
									<label><font size="3" color="black" face="Palatino linotype"><b><u>FORMULARIO DE COTIZACIÓN</u></b></font></label><br /><br />
								</td>
							</tr>
							<tr>
								<td colspan="3">
...
<script src="Validaciones/ValidaCotizacionCliente.js" type="text/javascript"></script>