...
<html Lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Play Music - Listado de Productos</title>
		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
					...
					<table width="970" bordercolor="#BDBDBD" border="0" cellpadding="1" cellspacing="1">
						<tr>
							...
							<td>
								...
								<li class="top"><a href="#" id="Promociones" class="top_link"><span><font color="yellow">BIENVENIDO "<?php echo strtoupper($_SESSION['miusuario']); ?>"</font></span></a></li>
							</ul>
							</td>
						</tr>
					</table>
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<div>
						<center>
							<a href="adminproductos.php"><input type="image" name="Details" src="Musica/btnBoton.png" width="80px" height="80px"/></a>
					</center>
					</div>
					</br>
					<div>
						<center>
							<a href="rptproductos.php/" target="_blank">Reporte Listado de Productos</a>
					</center>
					</div>
					<h2>Listado de Productos</h2><br/><br/>
					<center><div class="sinborde1">
						<table width="100%" align="center" class="tabla">
							<tr>
								<th align="center" width="120px" class="tha"><b>NOMBRE</b></th>
								<th align="center" width="60px" class="tha"><b>TIPO</b></th>
								<th align="center" width="130px" class="tha"><b>PLATAFORMA</b></th>
								<th align="center" width="120px" class="tha"><b>PRECIO VENTA</b></th>
								<th align="center" width="120px" class="tha"><b>PRECIO COSTO</b></th>
								<th align="center" width="100px" class="tha"><b>CATEGOR&Iacute;A</b></th>
								
							</tr>
							<?php require('filesphp/conexion.php');
							$usuario = $_SESSION['miusuario'];
							$consulta1 = mysql_query("SELECT nombre_prod, descripcion_prod, tipo_prod, plataforma_prod, precioventa_prod, preciocosto_prod, category_prot
							FROM productos inner join productstype on categoria_prod = id_prot");
							while ($fila1 = mysql_fetch_array($consulta1)) { ?>
							<tr>
								<td style="color:red" align="center" width="120px" class="tha"><?php echo $fila1['nombre_prod']; ?></td>
								<td style="color:red" align="center" width="60px" class="tha"><?php echo $fila1['tipo_prod']; ?></td>
								<td style="color:red" align="center" width="130px" class="tha"><?php echo $fila1['plataforma_prod']; ?></td>
								<td style="color:red" align="center" width="120px" class="tha"><?php echo $fila1['precioventa_prod']; ?></td>
								<td style="color:red" align="center" width="120px" class="tha"><?php echo $fila1['preciocosto_prod']; ?></td>
								<td style="color:red" align="center" width="100px" class="tha"><?php echo $fila1['category_prot']; ?></td>
								
							</tr>
							<?php } mysql_free_result($consulta1); ?>
						</table>
					</div></center>
					<center><font size="2"><br/><br/><b>NOTA:</b> Esta es información resumida de nuestros productos. Las im&aacute;genes de cada producto no se mostraron porque abarcaban<br/>
							mucho espacio entre cada fila y desconfiguraban los márgenes! <b>Sin embargo</b>, se aclara que &eacute;stas han sido almacenadas<br/>
							en la base de datos y en cualquier momento se podrían visualizar</font></center>
					<br /><br /><br /><br /><br /><br />
