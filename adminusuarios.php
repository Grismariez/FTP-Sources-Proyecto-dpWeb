							...
							<td>
									...
									if(isset($_GET['opc']))
									{
										...
										if($opc=='Buscar')
										{
											...
											$sql="Select * from registrados where nombres_reg like '%".$frase."%'";
										}
										if($opc=='Detalle')
										{
											$id=$_GET['id_reg'];
											$sql="Select * from registrados where id_reg=$id";
										}
										if($opc=='Eliminar')
										{
											$id=$_GET['id_reg'];
											$sql="Delete from registrados where id_reg=$id";
										...
										if($opc=='Modificar')
										{
											...
											$sql2="Select * from registrados where id_reg=$id";
											$mod=mysql_query($sql2);
											$usuario=mysql_fetch_array($mod);
									?>	
											<!-- Aqui va el formulario html //-->
									 
											<form name="frmMod" action="adminusuarios.php?opc=Actualizar" method="POST">
											<input type="hidden" name="tmpId" value="<?php echo $usuario['id_reg']; ?>">
											<table class="tabla">
											<tr>
											...
											<tr>
												...
												<td class="tda">
													<input type="text" name="txtNom" value="<?php echo $usuario['nombres_reg']; ?>"
												</td>
											</tr>
											<tr>
												<th class="tha">
												...
												<td class="tda">
													<input type="text" name="txtNick" value="<?php echo $usuario['nickname_reg']; ?>"
												</td>
											</tr>
											<tr>
												<th class="tha">
												...
												<td class="tda">
													<input type="text" name="txtMail" value="<?php echo $usuario['email_reg']; ?>"
												</td>
											</tr>
											<tr>
									...
									<?php
										...
										if($opc=='Actualizar')
										{
											...
											$nick=$_POST['txtNick'];
											$mail=$_POST['txtMail'];
											$sql="update registrados set nombres_reg='$nom', nickname_reg='$nick', email_reg='$mail' where id_reg=$id";
											header("location:adminusuarios.php");
										}
									}
									$result=mysql_query($sql);
									?>
									<form name="frm" method="POST" action="adminusuarios.php?opc=Buscar">
									<table border="0" cellspacing="0" cellpadding="0" class="tabla">
									<tr>
									<th class="tha" colspan="7"><h1>Mantenimiento de Usuarios</h1></th>
									</tr>

									<tr>
									<td class="tda"><a class="aa" href="Agrega_usuarios.php">Nuevo Usuario</a></td>
									<td class="tha" >Buscar:</td>
									<td class="tda"><input type="text" name="txtFrase"></td>
									<td colspan="4" class="tda">
										<input class="btna" type="submit" value="Buscar" name="btnBuscar">&nbsp;
										<a class="aa" href="adminusuarios.php">Ver Todos</a>
									</td>
									</tr>
									...
									?>
									<tr>
									<td class="tda"><?php echo $rows['id_reg']; ?></td>
									<td class="tda"><?php echo $rows['nombres_reg']; ?></td>
									<td class="tda"><?php echo $rows['nickname_reg']; ?></td>
									<td class="tda"><?php echo $rows['email_reg']; ?></td>
									<td class="tda">&nbsp;
									<a class="aa" href="adminusuarios.php?opc=Detalle&id_reg=<?php echo $rows['id_reg']; ?>">
									Detalle</a>&nbsp;</td>
									<td class="tda">&nbsp;
									<a class="aa" href="adminusuarios.php?opc=Eliminar&id_reg=<?php echo $rows['id_reg']; ?>"
									 onclick="return confirm('Seguro de eliminar el registro?');">
									Eliminar</a>&nbsp;</td>
									<td class="tda">&nbsp;
									<a class="aa" href="adminusuarios.php?opc=Modificar&id_reg=<?php echo $rows['id_reg']; ?>">
									Modificar</a>&nbsp;</td>
									</tr>
									<?php
									}
									...
									?>
									<br><br>
									<a class="aa" style="background-color:#9FF" href="Registro_admin.php">Regresar</a>
