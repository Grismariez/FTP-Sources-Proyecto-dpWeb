...
<html Lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Play Music - Agregar Contacto</title>
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<br/><br/><br/>
						<div>
						<center>
								<a href="admincontacto.php">Volver a Mantenimiento</a>
						</center>
					</div>
					<center><div class="formNewUser">
					<form action="filesphp/insert_contacto2.php" name="frmContac" id="frmContac" method="post" onsubmit="return Comprobar();">
						<table style="border-radius:15px" width="650" height="436">
							...
							<tr>
								<td colspan="4" align="center">
									<label><font size="3" color="red" face="Palatino linotype"><br/><b>* <?php echo $_SESSION['alertaContac']; ?></b><br/></font></label>
								</td>
							</tr>
							<tr>
								<td colspan="4">
