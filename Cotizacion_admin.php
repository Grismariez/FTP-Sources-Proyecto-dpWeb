...
<html Lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Play Music - Listado Cotizaciones</title>
		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<div>
						<center>
							<a href="admincotizacion.php"><input type="image" name="Details" src="Musica/btnBoton.png" width="80px" height="80px"/></a>
					</center>
					</div>
					</br>
					<div>
						<center>
							<a href="rptcotizacion.php/" target="_blank">Reporte Listado de Cotizaciones</a>
					</center>
					</div>
					<h2>Listado de Cotizaciones</h2><br/><br/>
					<center><div class="sinborde1">
						<table width="100%" align="center">
							<tr>
								<td align="center" width="80px"><b>CLIENTE</b></td>
								<td align="center" width="55px"><b>TEL&Eacute;FONO</b></td>
								<td align="center" width="175px"><b>E-MAIL</b></td>
								<td align="center" width="60px"><b>CATEGOR&Iacute;A</b></td>
								<td align="center" width="60px"><b>FORMATO</b></td>
								<td align="center" width="75px"><b>PRODUCTO</b></td>
								<td align="center" width="70px"><b>CANTIDAD</b></td>
								
							</tr>
							<?php require('filesphp/conexion.php');
							$usuario = $_SESSION['miusuario'];
							$consulta1 = mysql_query("SELECT nombre_cott, telefono_cott, email_cott, nombre_pais, category_prot,
							formato_cott, nomprod_cott, cantidad_cott FROM cotizaciones JOIN paises on pais_cott = id_pais 
							JOIN productstype ON id_prot = category_cott");
							while ($fila1 = mysql_fetch_array($consulta1)) { ?>
							<tr>
								<td style="color:red" align="center" width="80px"><?php echo $fila1['nombre_cott']; ?></td>
								<td style="color:red" align="center" width="55px"><?php echo $fila1['telefono_cott']; ?></td>
								<td style="color:red" align="center" width="175px"><?php echo $fila1['email_cott']; ?></td>
								<td style="color:red" align="center" width="60px"><?php echo $fila1['category_prot']; ?></td>
								<td style="color:red" align="center" width="60px"><?php echo $fila1['formato_cott']; ?></td>
								<td style="color:red" align="center" width="75px"><?php echo $fila1['nomprod_cott']; ?></td>
								<td style="color:red" align="center" width="70px"><?php echo $fila1['cantidad_cott']; ?></td>
