		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				...
				<?php require("filesphp/conexion.php"); 
						$consulta = mysql_query("SELECT * FROM productos WHERE tipo_prod = 'Musicas'");
				...
				<div class="sinborde">
					<table align="center" width="850">
						<tr>
							<td><?php echo $arreglo['descripcion_prod']; ?><br /><br /><br /></td>
						</tr>
						<tr>
							<td><input type="submit" class="style" id="music" name="music" value="Comprar Canci&oacute;n" /></td>
						</tr>
					</table>		
				</div>
				<br>
