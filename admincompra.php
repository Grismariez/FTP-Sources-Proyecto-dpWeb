...
if(isset($_GET['opc']))
{
	...
	if($opc=='Buscar')
	{
		...
		$sql="Select * from compra where nombretc_compra like '%".$frase."%'";
	}
	if($opc=='Detalle')
	{
		$id=$_GET['id_cliente'];
		$sql="Select * from compra where id_cliente=$id";
	}
	if($opc=='Eliminar')
	{
		$id=$_GET['id_cliente'];
		$sql="Delete from compra where id_cliente=$id";
		header("location:admincompra.php");
	}
	if($opc=='Modificar')
	{
...
?>
<form name="frm" method="POST" action="admincompra.php?opc=Buscar">
<table border="0" cellpadding="0" cellspacing="3px">
<tr>
<th class="tha" colspan="8"><h1>Mantenimiento Compra</h1></th>
</tr>
...
<td class="tda" colspan="5">
	...
	<a class="aa" href="admincompra.php">Ver Todos</a>
</td>
</tr>

<tr>
<th class="tha">Id</th>
<th class="tha">Fecha</th>
<th class="tha">Valor</th>
<th class="tha">Banco</th>
<th class="tha">No.Tarjeta</th>
<th class="tha">Tipo</th>
...
?>
<tr>
<td class="tda"><?php echo $rows['id_cliente']; ?></td>
<td class="tda"><?php echo $rows['fecha_compra']; ?></td>
<td class="tda"><?php echo $rows['valor_compra']; ?></td>
<td class="tda"><?php echo $rows['nombretc_compra']; ?></td>
<td class="tda"><?php echo $rows['numerotc_compra']; ?></td>
<td class="tda"><?php echo $rows['tipotc_compra']; ?></td>
<td class="tda">&nbsp;
<a class="aa" href="admincompra.php?opc=Detalle&id_cliente=<?php echo $rows['id_cliente']; ?>">
Detalle</a>&nbsp;</td>
<td width="70" class="tda">&nbsp;
<a class="aa" href="admincompra.php?opc=Eliminar&id_cliente=<?php echo $rows['id_cliente']; ?>"
...
?>
<br><br>
<a class="aa" href="Compra_admin.php" style="background-color:#9FF">Regresar</a>  
   </center> 
