...
<html Lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Play Music - Listado Encuestas</title>
		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<div>
						<center>
							<a href="adminencuesta.php"><input type="image" name="Details" src="Musica/btnBoton.png" width="80px" height="80px"/></a>
					</center>
					</div>
					<h2>Listado de las Encuestas</h2>
					<br /><br />
					<center><div class="sinborde1">
						<table width="100%" align="center">
							<tr>
								<td align="center" width="55px" ><b>USUARIO</b></td>
								<td align="center" width="65px" ><b>RESPUESTA1</b></td>
								<td align="center" width="65px" ><b>RESPUESTA2</b></td>
								<td align="center" width="65px" ><b>RESPUESTA3</b></td>
								<td align="center" width="105px" ><b>RESPUESTA4</b></td>
								<td align="center" width="65px" ><b>RESPUESTA5</b></td>
								<td align="center" width="65px" ><b>RESPUESTA7</b></td>
								
							</tr>
								<?php require('filesphp/conexion.php');
								$usuario = $_SESSION['miusuario'];
								$consulta1 = mysql_query("SELECT * FROM encuesta ");
								while ($fila1 = mysql_fetch_array($consulta1)) { ?>
							<tr>
								<td style="color:red" align="center" width="55px" ><?php echo $fila1['alias_encu']; ?></td>
								<td style="color:red" align="center" width="65px" ><?php echo $fila1['answerpreg1_encu']; ?></td>
								<td style="color:red" align="center" width="65px" ><?php echo $fila1['answerpreg2_encu']; ?></td>
								<td style="color:red" align="center" width="65px" ><?php echo $fila1['answerpreg3_encu']; ?></td>
								<td style="color:red" align="center" width="105px"><?php echo $fila1['answerpreg4_encu']; ?></td>
								<td style="color:red" align="center" width="65px" ><?php echo $fila1['answerpreg5_encu']; ?></td>
								<td style="color:red" align="center" width="65px" ><?php echo $fila1['answerpreg7_encu']; ?></td>
