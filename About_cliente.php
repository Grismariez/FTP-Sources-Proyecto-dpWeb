...
<html Lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Play Music - Acerca de</title>
					...
					<table width="970" bordercolor="#BDBDBD" border="0" cellpadding="1" cellspacing="1">
						<tr>
							...
							<ul class="borde" id="nav">
								...
								<li class="top"><a href="#" id="carrito" class="top_link"><span class="down"><font color="yellow">CARRITO</font></span></a>
									<ul class="sub">
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<table align="center" width="800">
						<tr>
							<td align="center">
								<img class="Rotar" src="Images AboutGroup/infoPage.png" width="240" height="125" title="Infor Página"/>
							</td>
							<td align="left" style="text-shadow: 5px 5px 5px red">
								<font size="3" face="Palatino linotype"><b>TODO ACERCA DE PLAY MUSIC</b></font>
							</td>
						</tr>
						<tr>
							<td colspan="2" align="justify" style="text-shadow: 5px 5px 5px lightblue">
							<br /><br />
								<font size="3" face="Palatino linotype">El objetivo de PlayMusic consiste en mostrar los diferentes juegos y genero de musica al mundo.
									<ul align="left">
						...
						<tr>
							<td colspan="2" align="justify" style="text-shadow: 5px 5px 5px lightblue">
								<font size="3" face="Palatino linotype">La pagina fue creada con el objetivo de que puedas encontrar diferentes tipos de juegos y musica en la cual tu puedas elegir lo que quieras; tiene lo mejor de musica y juegos en los cuales puedes ver las descripciones de cada juego y generos de la musica que quieras escuchar.</font>
								<br /><br />
								<b>Noticias de PlayMusic</b><br /><br />
								Consulta las ultimas noticias explora la pagina de productos o sigue una serie de paginasde PlayMusic para conocer novedades relacionadas con diferentes productos e iniciativas.								
								<br /><br />
								<b>Quienes Somos</b>
								<br /><br />
								Somos quienes podemos ofrecerte los mejores productos en entretenimiento de juegos.<br />   
								PlayMusic te proporciona musica de todo genero para que puedas disfrutar a la hora que quieras.      
								<br /><br />
								<b>Productos y Servicios</b>
								<br /><br />
								Mantente al tanto de nuestra pagina para tener lo nuevo y actualizado en juegos y musica en el cual puedes <a href="Registro.html"> Reg&iacute;strarte
							    </a>y darnos tu opinion en nuestra breve <a href="Encuesta.php">Encuesta</a>.
							</td>
						</tr>
					</table>
					<br /><br /><br /><br /><br />
