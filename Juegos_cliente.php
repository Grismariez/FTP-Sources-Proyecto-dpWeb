		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				...
				<?php require("filesphp/conexion.php"); 
						$consulta = mysql_query("SELECT * FROM productos WHERE tipo_prod = 'Juegos'");
				...
				<div class="sinborde">
					<table>
						<tr>
							<td class="titte" colspan="3"><h3><?php echo $arreglo['nombre_prod']; ?></h3></td>
						</tr>
						<tr>
							<td><img style="-webkit-box-shadow: 6px 6px 2px #888888" class="tamaño" src="filesphp/fotos/<?php echo $arreglo['foto']; ?>" width="200" height="200" align="left" ></img></td>
							<td>&nbsp;&nbsp;&nbsp;</td>
							<td><p class="color" ><?php echo $arreglo['genero_prod']; ?></p><br>
								<p class="alinear" style="text-shadow: 5px 5px 5px lightblue"><?php echo $arreglo['descripcion_prod']; ?></p><br>
							<input type="submit" class="style" id="Cotiz" name="Cotiz" value="Comprar Juego" /></td>
						</tr>
						<tr><td>&nbsp;</td></tr>
					</table>		
				</div>
				...
				<?php } mysql_free_result($consulta); mysql_close(); ?>
				<br /><br /><br /><br />
