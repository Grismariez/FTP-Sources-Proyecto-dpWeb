		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<div>
						<center>
							<a href="admincontacto.php"><input type="image" name="Details" src="Musica/btnBoton.png" width="80px" height="80px"/></a>
					</center>
					</div>
					</br>
					<div>
						<center>
							<a href="rptcontactos.php/" target="_blank">Reporte Listado de Mensajes</a>
					</center>
					</div>
					...
					<center><div class="sinborde1">
						<table width="100%" align="center">
							<tr>
								<td align="center" width="75px"><b>NOMBRE</b></td>
								<td align="center" width="180px"><b>E-MAIL</b></td>
								<td align="center" width="60px"><b>ASUNTO</b></td>
								<td align="center" width="200px"><b>MENSAJE</b></td>
								<td align="center" width="75px"><b>PA&Iacute;S</b></td>
								
							</tr>
							<?php require('filesphp/conexion.php');
							$usuario = $_SESSION['miusuario'];
							$consulta1 = mysql_query("SELECT usuario_mje, email_mje, asunto_mje, descripcion_mje, nombre_pais
							FROM mensajes inner join paises on id_pais_mje=id_pais");
							while ($fila1 = mysql_fetch_array($consulta1)) { ?>
							<tr>
								<td style="color:red" align="center" width="75px"><?php echo $fila1['usuario_mje']; ?></td>
								<td style="color:red" align="center" width="180px"><?php echo $fila1['email_mje']; ?></td>
								<td style="color:red" align="center" width="60px"><?php echo $fila1['asunto_mje']; ?></td>
								<td style="color:red" align="center" width="200px"><?php echo $fila1['descripcion_mje']; ?></td>
								<td style="color:red" align="center" width="75px"><?php echo $fila1['nombre_pais']; ?></td>
