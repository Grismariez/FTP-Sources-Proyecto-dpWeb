		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<div>
						<center>
							<a href="admindetalle.php"><input type="image" name="Details" src="Musica/btnBoton.png" width="80px" height="80px"/></a>
					</center>
					</div>
					...
					<center><div class="sinborde1">
						<table width="100%" align="center">
							<tr>
								...
								<td align="center" width="180px"><b>PRECIO</b></td>
								<td align="center" width="60px"><b>CANTIDAD</b></td>
							</tr>
							<?php require('filesphp/conexion.php');
							$usuario = $_SESSION['miusuario'];
							$consulta1 = mysql_query("SELECT producto_detallec, precio_detallec, cantidad_detallec, id_compra
							FROM detallecompra");
							while ($fila1 = mysql_fetch_array($consulta1)) { ?>
							<tr>
								<td style="color:red" align="center" width="75px"><?php echo $fila1['producto_detallec']; ?></td>
								<td style="color:red" align="center" width="180px"><?php echo $fila1['precio_detallec']; ?></td>
								<td style="color:red" align="center" width="60px"><?php echo $fila1['cantidad_detallec']; ?></td>
							</tr>
