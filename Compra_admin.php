...
<html Lang="en-US">
	<head>
		<meta charset="UTF-8">
		<title>Play Music - Listado Mensajes de Contacto</title>
		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<div>
						<center>
							<a href="admincompra.php"><input type="image" name="Details" src="Musica/btnBoton.png" width="80px" height="80px"/></a>
					</center>
					</div>
					</br>
					<div>
						<center>
							<a href="rptcompra.php/" target="_blank">Reporte Listado de Productos</a>
					</center>
					</div>
					<h2>Listado de Contactos</h2><br/><br/>
					<center><div class="sinborde1">
						<table width="100%" align="center">
							<tr>
								<td align="center" width="75px"><b>FECHA</b></td>
								<td align="center" width="180px"><b>VALOR</b></td>
								<td align="center" width="60px"><b>BANCO</b></td>
								<td align="center" width="200px"><b>N°TARJETA</b></td>
								<td align="center" width="75px"><b>TIPO</b></td>
								
							</tr>
							<?php require('filesphp/conexion.php');
							$usuario = $_SESSION['miusuario'];
							$consulta1 = mysql_query("SELECT fecha_compra, valor_compra, estado_compra, nombretc_compra, bancotc_compra,
							numerotc_compra, mestc_compra, aniotc_compra, tipotc_compra FROM compra");
							while ($fila1 = mysql_fetch_array($consulta1)) { ?>
							<tr>
								<td style="color:red" align="center" width="75px"><?php echo $fila1['fecha_compra']; ?></td>
								<td style="color:red" align="center" width="180px"><?php echo $fila1['valor_compra']; ?></td>
								<td style="color:red" align="center" width="60px"><?php echo $fila1['nombretc_compra']; ?></td>
								<td style="color:red" align="center" width="200px"><?php echo $fila1['numerotc_compra']; ?></td>
								<td style="color:red" align="center" width="75px"><?php echo $fila1['tipotc_compra']; ?></td>
