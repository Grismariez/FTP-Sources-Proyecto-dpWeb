			...
			<tr align="justify" height="200">
				<td colspan="3">
					...
					<center>
						<div>
							<div id="slider">
								<img src="Slide/images/1.jpg" alt="Bienvenidos a Play Music" />
								<img src="Slide/images/2.png" alt="Descarga Ya!! Dare La La La" />
								<img src="Slide/images/3.jpg" alt="Descargas Online, Juegos y Más" />
							</div>
						</div>	
					</center>			
					<table align="center" width="700">
						<tr>
							<br /><br /><br />
							<td colspan="5" align="justify" style="text-shadow: 5px 5px 5px lightblue">
								<font size="3" color="#1C1C1C" face="Palatino linotype">
									<b>Play Music</b> = Tu mejor opci&oacute;n en tiendas online para adquirir y disfrutar tu m&uacute;sica y juegos favoritos, 
							con precios amigables y cómodas ofertas para tu bolsillo.<br />
							Garantizamos adem&aacute;s, alta seguridad en las entregas electr&oacute;nicas de nuestros productos a cualquier parte del mundo.<br />
							En nuestras galerías podrás encontrar excelentes piezas musicales - solo en los mejores formatos de reproducci&oacute;n- y de todo g&eacute;nero (Reggaeton - Pop - Rap - Baladas - Rom&aacute;nticas - Bachatas - Cumbias, etc.) 
							Ofrecemos tambi&eacute;n, la mejor calidad de videojuegos en las opciones Online y Ejecutables -en todas las categor&iacute;as alojadas en nuestro servidor web; listos para que los descargues y empieces a interactuar con los 
							mejores gr&aacute;ficos, animaciones y efectos especiales que hallas imaginado.<br /> Apto para poner a prueba tus emociones y elevar al m&aacute;ximo el nivel de adrenalina.</font>
							</td>
						</tr>
						<tr>
							<td align="center" class="Rotar">
								<input type="image" src="Css File/Calendario/ima/calendario.png" width="300" height="25" title="Click - Ver Calendario" name="lanzador" id="lanzador" class="borde">
							...
							<td>
								<br /><br /><br />
								<center><img class="Rotar" src="Images Index/GraciasVisitas.gif" height="115" width="240"/></center>
							</td>
						</tr>
					</table>
					<embed wmode="transparent" src="http://www.goear.com/playlist/109810f/playmusicutec" autostart="true" loop="true" width="0" height="0" />
					<br /><br /><br /><br /><br />
					<table align="center">
						<tr>
							<td colspan="2">
								<input type="image" align="center" class="Rotar" id="Chrome" src="Images Index/GoogleChrome.png" title="Chrome" width="30" height="30" />
							</td>
							<td align="center">
								<marquee><font size="2" color="#1C1C1C" face="Palatino linotype">Sitio Web Optimizado para Google Chrome</font></marquee>
							</td>
						</tr>
					</table>
