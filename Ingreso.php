	...
	<body class="fondo">
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				<td colspan="3">
				<br /><br />
				<center><div class="formLogUp">
					<form action="filesphp/checklogin.php" name="entry" id="entry" method="post" onsubmit="validaFields();">
						<table style="border-radius:15px;" width="620" height="271">
							<tr>
								<td colspan="6">
									<label><font color="white" size="3" face="Palatino linotype">&nbsp;</font></label>
								</td>
							</tr>
							<tr>
								<td colspan="6">
							...
							<tr>
								<td colspan="6" align="center">
									<label><font color="black" size="3" face="Palatino linotype"><b><u>FORMULARIO DE INGRESO</u></b></font></label>
								</td>
							</tr>
							<tr>
								<td colspan="6" align="center">
							...
							<tr>
								...
								<td colspan="4" align="left">
									<input type="email" name="usua" id="usua" placeholder="alguien@ejemplo.com" required />
								</td>
							</tr>
							<tr>
								<td>
								...
								<td align="left">
									<label><font color="black" size="3" face="Palatino linotype">Clave:</font></label>
								</td>
								<td align="left">
									<input type="password" name="clave" size="17" id="clave" placeholder="Contraseña" required />
								</td>
								<td align="left" colspan="2">
									<label id="Rest" name="Rest"><a href="RestablecimientoClave.html"><font color="black" size="3" face="Palatino linotype">¿Olvidaste tu contraseña?</font></a><label/>
								</td>
								<td>
									<label><font color="black" size="3" face="Palatino linotype">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></label>
								</td>
							...
							<tr>
								...
								<td align="left">
									<input type="submit" class="style" name="Ingresar" id="Ingresar" value="Iniciar Sesión" onclick="validaFields();" readonly="true" href="index.html"></input>
								</td>
								<td align="left">
									<input type="button" class="style" name="Registro" id="Registro" value="Reg&iacute;strate" readonly="true" href="Registro.php"></input>
								</td>
							</tr>
							<tr>
								<td colspan="6">
									<label><font color="red" size="3" face="Palatino linotype"><br/>
									<label><b>* <?php echo $_SESSION['alerta']; ?></b></label>
									<br/><br/></font></label>
								</td>
							</tr>
							<tr>
...
<script src="Validaciones/ValidaLogin.js" type="text/javascript"></script>