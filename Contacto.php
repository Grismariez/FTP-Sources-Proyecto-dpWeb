	...
	<body class="fondo">
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				<td colspan="3">
				<br /><br />
				<center><div class="formContUp">
					<form action="filesphp/insert_contacto_publicos.php" name="frmContac" id="frmContac" method="post" onsubmit="return Comprobar();">
						<table style="border-radius:15px" width="650" height="436">
							<tr>
								<td colspan="4">
									<label><font size="3" face="Palatino linotype">&nbsp;</font></label>
								</td>
							...
							<tr>
								<td colspan="4" align="center">
									<label><font color="black" size="3" face="Palatino linotype"><b><u>FORMULARIO DE CONTACTO</u></b></font></label><br/><br/>
								</td>
							</tr>
							<tr>
								<td colspan="4">
							...
							<tr>
								<td>
									<label><font size="3" face="Palatino linotype">&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></label>
								</td>
								<td align="left">
									<label><font color="black" size="3" face="Palatino linotype">Nombre:</font></label>
								</td>
								<td align="left">
									<input type="text" name="alias" id="alias" title="Se necesita un nombre." onkeypress="return soloLetras(event)" Required />
								</td>
								<td>
									<label><font size="3" face="Palatino linotype">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></label>
							...
							<tr>
								...
								<td align="left">
									<label><font color="black" size="3" face="Palatino linotype">E-mail:</font></label>
								</td>
								<td align="left">
									<input type="email" name="correo" id="correo" placeholder="alguien@ejemplo.com" Required />
								</td>
								<td>
									<label><font size="3" face="Palatino linotype">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></label>
							...
							<tr>
								...
								<td align="left">
									<label><font color="black" size="3" face="Palatino linotype">Asunto:</font></label>
								</td>
								<td align="left">
							...
							<tr>
								...
								<td align="left">
									<label><font color="black" size="3" face="Palatino linotype">Pais:</font></label>
								</td>
								<td align="left">
							...
							<tr>
								...
								<td align="left">
									<label><font color="black" size="3" face="Palatino linotype">Mensaje:</font></label>
									
								</td>
								<td align="left">
									<textarea name="message" id="message" cols="55" rows="6" Required></textarea>
								</td>
								<td>
									<label><font size="3" face="Palatino linotype">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></label>
							...
							<tr>
								...
								<td colspan="2" align="left">
									<br />
									<input type="submit" class="style" name="Enviar" id="Enviar" value="Enviar Mensaje" onclick="return Comprobar();" />&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
									<input type="reset" class="style" name="borrarMje" id="borrarMje" value="Cancelar" />
								</td>
							</tr>
							<tr>
								<td colspan="4" align="center">
									<label><font size="3" color="red" face="Palatino linotype"><br/><b>* <?php echo $_SESSION['alertaContac']; session_destroy(); ?></b><br/></font></label>
								</td>
							</tr>
							<tr>
								<td colspan="4">
...
<script src="Validaciones/ValidaContacto.js" type="text/javascript"></script>