		...
		<table align="center" width="998" border="0" bgcolor="#FFFFFF" id="sombra_body">
			...
			<tr align="justify" height="200">
				...
				<center><div class="formContUp">
					<form action="filesphp/insert_contacto_clientes.php" name="frmContac" id="frmContac" method="post" onsubmit="return Comprobar();">
						<table style="border-radius:15px" width="650" height="436">
							<tr>
								<td colspan="4">
									<br/><label><font size="3" color="red" face="Palatino linotype"><br/><b>* <?php echo $_SESSION['alertaContacC']; ?></b></font></label><br/><br/>
								</td>
							</tr>
							<tr>
								<td colspan="4">
							...
							<tr>
								<td colspan="4" align="center">
									<label><font color="black" size="3" face="Palatino linotype"><b><u>FORMULARIO DE CONTACTO</u></b></font></label><br/><br/><br/>
								</td>
							</tr>
							<tr>
								<td>
